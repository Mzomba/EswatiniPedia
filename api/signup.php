      ...
      $check = "select * from users where username='{$username}'";
            ...
            if (mysqli_num_rows($result) > 0) {
              echo "<div class='message'>
                        <p class='text-center text-danger fw-bold fs-4'>This email is used, Try another One Please!</p>
                    </div><br>
                    ";
              echo "<a href='javascript:self.history.back()' class='d-flex justify-content-center align-item-center'><button class='btn btn-secondary'>Go Back</button></a>";
            } else {
              if ($password === $repeatpassword) {
                  ...
                  if ($result) {      
                    ...
                    echo "<div class='message'>
                            <p class='text-danger fw-bold fs-4'>This email is used, Try another One Please!</p>
                          </div><br>";
                          echo "<a href='javascript:self.history.back()' class='d-flex justify-content-center align-item-center'><button class='btn btn-secondary'>Go Back</button></a>";
                  }
                  } else {
                    echo "<div class='message'>
                            <p class='text-danger fw-bold fs-4'>Password does not match.</p>
                          </div><br>";
                          echo "<a href='signup.php class='d-flex justify-content-center align-item-center'><button class='btn btn-econdary'>Go Back</button></a>";
                  }
                }
              } else {
              ?>
          ...
          <div class="card-body p-3 p-md-4 p-xl-5">
            ...
            <form action="#" method="POST" enctype="multipart/form-data">
              <div class="row gy-3 overflow-hidden">
                ...
                <div class="col-12">
                  <div class="form-floating mb-3">
                    <input type="password" class="form-control password" name="repeatpassword" id="password" value="" placeholder="Repeat Password" required>
